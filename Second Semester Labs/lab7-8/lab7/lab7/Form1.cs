...
namespace lab7
{
    public partial class Form1 : Form
    {
        ...
        private void calculateButton_Click(object sender, EventArgs e)
        {
            ...
            Forma circle = new Circle(circleRadius);
            ...
            Forma cone = new Cone(coneRadius, coneHeiht);
            ...
            Forma truncCone = new TruncCone(truncConeBigRadius, truncConeSmallRadius, truncConeHeight);
